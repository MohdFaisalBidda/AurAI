      ...
      <div className="flex flex-col gap-4">
            ...
            <button
              ...
              className={`flex items-center gap-2 rounded-xl px-4 py-2 text-sm transition-all duration-300 cursor-pointer justify-center border ${
                activeTab === tab.id
                  ...
                  : "bg-gradient-to-tl from-[#1E293B] to-[#111827] text-muted-foreground hover:bg-muted/60 hover:text-foreground"
              } `}
            >
              {tab.icon}
              {activeTab === tab.id && (
        ...
        <div className="flex flex-col">
          {activeTabData?.content.map((item, index) => (
            ...
            >
              <button className="w-full rounded-md py-2 text-left hover:bg-gradient-to-tl from-[#1E293B] to-[#111827] cursor-pointer sm:px-3">
                {item}
              </button>
            </div>
          ))}
